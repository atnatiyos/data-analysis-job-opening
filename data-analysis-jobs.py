...
data_set = pandas.read_csv("final_data.csv")
...
def detail_graph(name,type,designation):
    ...
    bar_chart =  px.bar( x=data.columns[10:], y=required_skill, title="Job levels percentage requirement",color=required_skill)
